...
import { EletricProps } from '../response'

export default class RegularEletric extends Component {
    state = {
        setNominal: [],
        setContacts: [],
        setNumber: '',
    ...
    _onRetrieveValNominal = async () => {
        try {
            ...
            let urii = dev_net()+`prefix-uncode-trx/markup/${id}/${isOperator}`
            ...
            >
                    ...
                    </Form>
                {
                  ...
                  <FlatList
                      ...
                      renderItem={({item}) => <EletricProps item={item}
                            onPress={() => {
